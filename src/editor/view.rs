...
impl EditorWindow
{
    pub fn new(file_path: &Path) -> Result<&'static mut Self, NwgError>
    {
        init()?;
        let mut this = Self
        {
        ...
        Button::builder()
            ...
            .flags( ButtonFlags::VISIBLE )
            .text( "Save" )
        .build( &mut this.btn_save )?;

        Ok( alloc_leaked!( this ) )
    }
}